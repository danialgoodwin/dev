...
2.  (Maybe) I've been able to do all this Android development while simultaneous being pulling in all directions for running a startup business. I've carried multiple responsibilities with ease and have been able to accomplish all of them. (So, if I'm able to put more of my focus in Android development, then I can definitely do a lot more great things.) Leading question to ask interviewer: Do you ever have responsibilities outside of direct Android source code manipulation?
