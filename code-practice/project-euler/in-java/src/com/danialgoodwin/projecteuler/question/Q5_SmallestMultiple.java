/**
 * Created by Danial on 2014-09-20.
 */
 ...
 */
public class Q5_SmallestMultiple extends Question {
    ...
    public void solve() {
        ...
        timer.start();
        int answer = getLeastCommonMultiple(numbers);
        timer.stop();
        log("Answer: " + answer + ", time: " + timer.getLapTime());
    }
     ...
     * Space: O(), time: O()
     * @param numbersInput list of positive numbers
     * @return LCM, which may overflow
     */
    private int getLeastCommonMultiple(List<Integer> numbersInput) {
        ...
        List<Integer> numbers = new LinkedList<Integer>(numbersInput); // Defensive copy.
