 ...
 */
public class Q18_MaximumPathSum1 extends Question {

    @Override
    protected String getQuestionName() {
        return "Q18_MaximumPathSum1";
    }
...
//            digits = FileUtils.readAllLines("src/com/danialgoodwin/projecteuler/sourcefile/q18-maximum-path-sum-1-sample.txt", StandardCharsets.UTF_8);
            digits = FileUtils.readAllLines("src/com/danialgoodwin/projecteuler/sourcefile/q18-maximum-path-sum-1.txt", StandardCharsets.UTF_8);
